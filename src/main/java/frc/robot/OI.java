...
public class OI {
	...
	public static final JoystickButton driveButtonY = new JoystickButton(driveController, 4);
	...
	public static final JoystickButton coDriverButtonX = new JoystickButton(coDriverController, 3);
	...
	public OI(Robot robot) {
		...
		driveButtonY.whenPressed(new ToggleLimitSpeed(robot.drivetrain));
		
		
		// Co Driver Controller
		coDriverButtonY.whenPressed(new ToggleHighShooter(robot.highShooter));
		coDriverButtonB.whenPressed(new ToggleFlipper(robot.flipper));
		coDriverButtonX.whenPressed(new ToggleHighShooter2(robot.highShooter));
